...
pub_raw_imu =  rospy.Publisher('raw_imu', roscopter.msg.Mavlink_RAW_IMU, queue_size = 1)
pub_status = rospy.Publisher('status', roscopter.msg.Status, queue_size = 1)
pub_filtered_pos = rospy.Publisher('filtered_pos', roscopter.msg.FilteredPosition, queue_size = 1)
